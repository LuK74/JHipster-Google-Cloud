...
```
$ docker image tag gateway luk74/gateway
$ docker push luk74/gateway
$ docker image tag invoice luk74/invoice
$ docker push luk74/invoice
$ docker image tag notification luk74/notification
$ docker push luk74/notification
```
